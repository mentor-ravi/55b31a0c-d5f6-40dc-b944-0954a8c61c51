  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md backdrop-blur-xl bg-card/95 border-primary/20">
        <DialogHeader>
          ...
          {message && <DialogDescription className="text-center">
              <span className="text-primary font-medium">{message}</span>
            </DialogDescription>}
          {isSignUp && !message && <DialogDescription className="text-center">
        ...
        <div className="space-y-4">
          <form onSubmit={handleAuth} className="space-y-4">
            {isSignUp && <>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="mobileNumber" type="tel" placeholder="1234567890" value={formData.mobileNumber} onChange={e => setFormData({
                  ...formData,
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                <Input id="email" type={isSignUp ? "email" : "text"} placeholder={isSignUp ? "you@example.com" : "Email or Mobile Number"} value={formData.email} onChange={e => setFormData({
                ...formData,
            ...
            {isSignUp && <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                  <Input id="confirmPassword" type={showConfirmPassword ? "text" : "password"} placeholder="••••••••" value={formData.confirmPassword} onChange={e => setFormData({
                ...formData,
            ...
            {isSignUp && <div className="flex items-start space-x-2">
